        ...
        <aside class="chitchat-left-sidebar left-disp">
                                    ...
                                    <div class="tab-content" id="myTabContent1">
                                        <div class="tab-pane fade show active" id="direct" role="tabpanel" aria-labelledby="direct-tab">
                                            <ul id="chat-list" class="chat-main">
                                                @foreach($listChat as $r)
                                                    ...
                                                    <li class="" userid="{{$r->userid}}" >
                                                        <div class="chat-box">
                                                            <div class="profile online">
                                                              
                                                                   <img class="bg-img" src="{{ url('storage/'.$r->avata)}}" alt="Avatar" />
                                                          
                                                            </div>
                                                            <div class="details">
                                                                <h5>{{$r->name}}</h5>
                                                                <h6 class="mes">Typing................</h6>
                                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="group" role="tabpanel" aria-labelledby="group-tab">
                                            ...
                                            <ul id="groupchat" class="group-main">
                                                ...
                                                <li data-to="group_blank">
                                                    <div class="group-box">
                                                        <div class="profile"><img class="bg-img" src='{{asset("assets/images/avtar/girls.jpg")}}' alt="Avatar" /></div>
                                                        <div class="details">
                ...
                @foreach($listFriend as $r)
                    <li>
                        <div class="chat-box">
                            ...
                            <div class="profile offline"><img class="bg-img" src="{{ url('storage/'.$r->avata)}}" alt="Avatar" /></div>
            ...
            <div class="status-tab custom-scroll dynemic-sidebar" id="status">
                    ...
                    <div class="status-content">
                        <div class="media">
                            <div class="img-status">
                                <div class="user-status two"><img class="img-fluid bg-img" src='{{asset("assets/images/avtar/girls.jpg")}}' alt="status" /></div>
                ...
                <div class="contact-status-box">
                    ...
                    <div class="status-content">
                        <ul>
                            <li class="user-status"><a class="lightbox img-status status" href="#statusbox"><img class="img-fluid bg-img" src='{{asset("assets/images/status-img/small/sm-1.jpg")}}' alt="status"/></a>
                                <div class="lightbox-target" id="statusbox"><img src='{{asset("assets/images/status-img/large/lg-1.jpg")}}' alt="status" /><a class="lightbox-close" href="#"></a></div>
                            </li>
                            <li>
                    ...
                    <div class="status-content">
                        <ul>
                            <li class="user-status"><a class="lightbox img-status status" href="#statusbox2"><img class="img-fluid bg-img" src='{{asset("assets/images/status-img/small/sm-2.jpg")}}' alt="status"/></a>
                                <div class="lightbox-target" id="statusbox2"><img src='{{asset("assets/images/status-img/large/lg-2.jpg")}}' alt="status" /><a class="lightbox-close" href="#"></a></div>
                            </li>
                            <li>
                                <h5>Jony Lynetin</h5>
                                <p>today , 10:30am</p>
                    ...
                    <div class="status-content">
                        <ul>
                            <li class="user-status"><a class="lightbox img-status status" href="#statusbox3"><img class="img-fluid bg-img" src='{{asset("assets/images/status-img/small/sm-3.jpg")}}' alt="status"/></a>
                                <div class="lightbox-target" id="statusbox3"><img src='{{asset("assets/images/status-img/large/lg-3.jpg")}}' alt="status" /><a class="lightbox-close" href="#"></a></div>
                            </li>
                            <li>
                                <h5>Sufiya Elija</h5>
                                <p>today , 11:00am</p>
                    ...
                    <div class="status-content">
                        <ul>
                            <li class="user-status"><a class="lightbox img-status status" href="#statusbox4"><img class="img-fluid bg-img" src='{{asset("assets/images/status-img/small/sm-4.jpg")}}' alt="status"/></a>
                                <div class="lightbox-target" id="statusbox4"><img src='{{asset("assets/images/status-img/large/lg-4.jpg")}}' alt="status" /><a class="lightbox-close" href="#"></a></div>
                            </li>
                            <li>
                    ...
                    <div class="status-content">
                        <ul>
                            <li class="user-status"><a class="lightbox img-status status" href="#statusbox5"><img class="img-fluid bg-img" src='{{asset("assets/images/status-img/small/sm-5.jpg")}}' alt="status"/></a>
                                <div class="lightbox-target" id="statusbox5"><img src='{{asset("assets/images/status-img/large/lg-5.jpg")}}' alt="status" /><a class="lightbox-close" href="#"></a></div>
                            </li>
                            <li>
                    ...
                    <div class="status-content">
                        <ul>
                            <li class="user-status"><a class="lightbox img-status status" href="#statusbox6"><img class="img-fluid bg-img" src='{{asset("assets/images/status-img/small/sm-3.jpg")}}' alt="status"/></a>
                                <div class="lightbox-target" id="statusbox6"><img src='{{asset("assets/images/status-img/large/lg-3.jpg")}}' alt="status" /><a class="lightbox-close" href="#"></a></div>
                            </li>
                            <li>
                                <h5>Sufiya Elija</h5>
                                <p>today , 11:00am</p>
                                            ...
                                            <ul class="msg-box">
                                                ...
                                                <li class="msg-setting-main">
                                                    <div class="document"><i class="fa fa-file-excel-o font-primary"></i>
                                                        ...
                                                        <div class="icon-btns"><a class="icon-btn btn-outline-light" href='{{asset("assets/doc/Document.xlsx")}}' target="_blank"><i data-feather="download"> </i></a></div>
                                                    </div>
                                            ...
                                            <ul class="msg-box">
                                                ...
                                                <li class="msg-setting-main">
                                                    <ul class="auto-gallery">
                                                        <li><img class="bg-img" src='{{asset("assets/images/media/1.jpg")}}' alt="Avatar" /></li>
                                                        <li> <img class="bg-img" src='{{asset("assets/images/media/2.jpg")}}' alt="Avatar" /></li>
                                                        <li> <img class="bg-img" src='{{asset("assets/images/media/3.jpg")}}' alt="Avatar" /></li>
                                                    </ul>
                    ...
                    <div class="contact-chat">
                        <ul class="chatappend">
                            <li class="groupuser">
                                ...
                                <div class="gr-profile dot-btn dot-success grow"><img class="bg-img" src='{{asset("assets/images/avtar/3.jpg")}}' alt="Avatar" /></div>
                                <div class="gr-profile dot-btn dot-success grow"><img class="bg-img" src='{{asset("assets/images/avtar/5.jpg")}}' alt="Avatar" /></div>
                            </li>
                            <li class="sent">
                                <div class="media">
                                    <div class="profile mr-4"><img class="bg-img" src='{{asset("assets/images/contact/2.jpg")}}' alt="Avatar" /></div>
            ...
            <div id="app" class="modal-body">
                    <div class="videocall call-modal">
                        ...
                        <div id="myVideoCall" class="small-image">
                            <video class="small-image bg-size" width="" height="" controls="">
                                <source src="https://www.w3schools.com/tags/movie.mp4" type="video/mp4">
                                <source src="https://www.w3schools.com/tags/movie.ogg" type="video/ogg">
                            </video>
                    ...
                    <div class="media videocall-details">
                        ...
                        <div class="zoomcontent"><a class="text-dark" href="#!" onclick="javascript:toggleFullScreen()" data-tippy-content="Zoom Screen"><img src='{{asset("assets/images/logo/maximize.svg")}}' alt="zoom screen"/></a></div>
                    </div>
                    <div class="center-con text-center">
                        <ul>
                ...
                <div class="modal-body">
                    ...
                    <ul class="chat-main custom-scroll">
                        ...
                        <li class="active" data-to="chating">
                            <div class="chat-box">
                                <div class="profile online"><img class="bg-img" src='{{asset("assets/images/contact/2.jpg")}}' alt="Avatar" /></div>
                                <div class="details">
                                    <h5>Jony Lynetin</h5>
                                    <h6>Typing................</h6>
                                </div>
                        ...
                        <li data-to="blank">
                            <div class="chat-box">
                                <div class="profile busy"><img class="bg-img" src='{{asset("assets/images/contact/4.jpg")}}' alt="Avatar" /></div>
                                <div class="details">
                                    <h5>Mukrani Pabelo</h5>
                                    <h6>Hi, i am josephin. How are you.. ! There are many variations of passages.</h6>
                                </div>
                        ...
                        <li data-to="blank">
                            <div class="chat-box">
                                <div class="profile busy"><img class="bg-img" src='{{asset("assets/images/contact/2.jpg")}}' alt="Avatar" /></div>
                                <div class="details">
                                    <h5>Jhon Deo</h5>
                                    <h6>Hi, i am josephin. How are you.. ! There are many variations of passages.</h6>
                                </div>
                        ...
                        <li data-to="blank">
                            <div class="chat-box">
                                <div class="profile busy"><img class="bg-img" src='{{asset("assets/images/contact/1.jpg")}}' alt="Avatar" /></div>
                                <div class="details">
                                    <h5>Pabelo Mukrani</h5>
                                    <h6>Hi, i am josephin. How are you.. ! There are many variations of passages.</h6>
                                </div>
